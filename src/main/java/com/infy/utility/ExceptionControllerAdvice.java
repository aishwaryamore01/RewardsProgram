...
public class ExceptionControllerAdvice {
   ...
   @ExceptionHandler(RewardprogramCustomerException.class)
   public ResponseEntity<ErrorInfo> meetingSchedulerExceptionHandler(RewardprogramCustomerException exception)
   {
